...
function blankEntity(id: number): Entity {
  return {
    ...
    spawnPos: { x: 0, y: 0, z: 0 }, aiActiveMoveTarget: null, aiActiveReturnAt: 0, aiActiveReturningHome: false,
    leashAnchor: null, evadeStall: 0, fleeTimer: 0, fleeReturnTimer: 0, hasFled: false, wanderTarget: null, wanderTimer: 0,
