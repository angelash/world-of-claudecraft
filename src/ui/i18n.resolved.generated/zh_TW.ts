...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hostedPlay": {
      ...
      "groupLeaderLabel": "隊長",
      "groupLeaderDistanceLabel": "與隊長距離",
      "socialPendingRepliesLabel": "待回覆",
      "socialFriendsLabel": "好友",
      "socialBlocksLabel": "已封鎖玩家",
      "lastWhisperFromLabel": "最近密語來自",
      "lastSocialActionLabel": "最近社交動作",
      "llmEnabledLabel": "LLM 輔助層",
      "llmPlanLabel": "LLM 計畫",
      "llmPlanModeLabel": "LLM 社交模式",
      "llmPlanFocusLabel": "LLM 關注點",
      "llmReplyLabel": "LLM 回覆",
      "llmReplyTargetLabel": "LLM 回覆目標",
      "pauseLabel": "暫停原因",
      "errorLabel": "執行期",
      "loadingStatus": "正在載入託管狀態...",
      ...
      "details": {
        ...
        "sectionParty": "隊伍",
        "sectionSocial": "社交",
        "sectionLlmPlan": "LLM 計畫",
        "sectionLlmSocial": "LLM 社交",
        "lastBrain": "最近腦 tick",
        "lastAutomation": "最近自動化 tick",
        "objectiveId": "目標 ID",
        "objectiveLabel": "目標說明",
        "objectiveQuest": "任務 ID",
        "objectiveDungeon": "地城 ID",
        "partySize": "建議隊伍人數",
        "objectiveSince": "目標開始於",
        "lastProgress": "最近進展",
        "lastError": "最近錯誤",
        "brainDrivePaused": "腦驅動暫停",
        "facing": "朝向",
        "pathGoal": "路徑目標",
        "pathLength": "路徑點數",
        "nextPathPoint": "下一個路徑點",
        "campIndex": "營地點序號",
        "noTargetSince": "無目標開始於",
        "stuckResets": "卡住重置次數",
        "travelGoal": "行進目標",
        "moveInput": "移動輸入",
        "commands": "命令",
        "lastCommandAges": "最近命令間隔",
        "groupMode": "組隊模式",
        "groupLeader": "隊長",
        "groupDistance": "隊伍距離",
        "partyPaused": "隊伍暫停腦驅動",
        ...
        "llmFocus": "關注點",
        "llmTarget": "目標",
        "promptChars": "Prompt 字元數",
        "rawOutputChars": "原始輸出字元數",
        "planPrompt": "計畫 Prompt",
        "planRawOutput": "計畫原始輸出",
        "socialPrompt": "社交 Prompt",
        "socialRawOutput": "社交原始輸出",
        "valueMs": "{value} ms",
        "timeWithAge": "{time}（{age}前）",
        "pointValue": "x {x}，z {z}",
        "travelGoalValue": "{target}，範圍 {range}，鍵 {key}",
        "commandHeader": "{index}. {summary}",
        "commandAgeValue": "{key}：{age}前",
        "pendingReplyHeader": "回覆 {name}，版本 {revision}",
        "pendingReplyIncoming": "收到內容",
        "pendingReplyFallback": "備用回覆",
        "pendingReplyDue": "到期時間",
        "pendingReplyAskedFriend": "是否要求好友",
        "pendingReplyLlmStatus": "LLM 狀態",
        "pendingReplyLlmReply": "LLM 回覆",
        "pendingReplyLlmFriend": "LLM 好友動作",
        "pendingReplyPresence": "存在感表情",
        "pendingReplyRequested": "LLM 請求於"
      },
      "log": {
        "accept": "託管：前往接取 {quest}。",
        "questWork": "託管：正在推進 {quest}。",
        "turnIn": "託管：前往交付 {quest}。",
        "resupply": "託管：前往商人處補給。",
        "upgrade": "託管：前往商人處購買升級。",
        "grind": "託管：正在刷怪取得經驗。",
        "recover": "託管：正在兩次戰鬥間恢復。",
        "retreat": "託管：正在撤退到安全位置。",
        "release": "託管：正在釋放靈魂。",
        "gatherParty": "託管：正在為 {quest} 集合隊伍。",
        "leaveDungeon": "託管：正在離開 {dungeon}。",
        "leaveDungeonForQuest": "託管：正在離開副本，準備交付 {quest}。"
      },
      "partyMode": {
        "solo": "單人推進",
        "followLeader": "跟隨隊長"
