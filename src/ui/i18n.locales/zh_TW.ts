...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.quests.q_nythraxis_bound_guardian.completion": "三件遺物講述著同一個故事：阿爾德倫為守護國王而戰，馬爾里克打破了死亡的界限，沃斯試圖阻止隨後發生的一切。封印正在減弱，而這枚印戒就是尼思拉克西斯陵墓的鑰匙。你現在已經完成調諧，可以進入尼思拉克西斯墓穴。回到廢棄墓穴，打開王室之門，在舊王的怒火溢出荊峰之前直面尼思拉克西斯。",
