...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hostedPlay.menuButton': '託管遊玩',
  'hudChrome.hostedPlay.title': '託管遊玩',
  'hudChrome.hostedPlay.statusLabel': '狀態',
  'hudChrome.hostedPlay.objectiveLabel': '目標',
  'hudChrome.hostedPlay.resumeOnLogin': '登入後恢復',
  'hudChrome.hostedPlay.partyModeLabel': '隊伍模式',
  'hudChrome.hostedPlay.partyModeStatusLabel': '隊伍行為',
  'hudChrome.hostedPlay.groupModeLabel': '目前隊伍狀態',
  'hudChrome.hostedPlay.groupLeaderLabel': '隊長',
  'hudChrome.hostedPlay.groupLeaderDistanceLabel': '與隊長距離',
  'hudChrome.hostedPlay.socialPendingRepliesLabel': '待回覆',
  'hudChrome.hostedPlay.socialFriendsLabel': '好友',
  'hudChrome.hostedPlay.socialBlocksLabel': '已封鎖玩家',
  'hudChrome.hostedPlay.lastWhisperFromLabel': '最近密語來自',
  'hudChrome.hostedPlay.lastSocialActionLabel': '最近社交動作',
  'hudChrome.hostedPlay.llmEnabledLabel': 'LLM 輔助層',
  'hudChrome.hostedPlay.llmPlanLabel': 'LLM 計畫',
  'hudChrome.hostedPlay.llmPlanModeLabel': 'LLM 社交模式',
  'hudChrome.hostedPlay.llmPlanFocusLabel': 'LLM 關注點',
  'hudChrome.hostedPlay.llmReplyLabel': 'LLM 回覆',
  'hudChrome.hostedPlay.llmReplyTargetLabel': 'LLM 回覆目標',
  'hudChrome.hostedPlay.pauseLabel': '暫停原因',
  'hudChrome.hostedPlay.errorLabel': '執行期',
  'hudChrome.hostedPlay.loadingStatus': '正在載入託管狀態...',
  'hudChrome.hostedPlay.statusLoadFailed': '目前無法載入託管狀態。',
  'hudChrome.hostedPlay.updateFailed': '目前無法更新託管狀態。',
  'hudChrome.hostedPlay.settingsSaveFailed': '目前無法儲存託管設定。',
  'hudChrome.hostedPlay.objectiveNone': '暫無活動目標',
  'hudChrome.hostedPlay.enable': '啟用託管遊玩',
  'hudChrome.hostedPlay.disable': '停用託管遊玩',
  'hudChrome.hostedPlay.refresh': '重新整理',
  'hudChrome.hostedPlay.runtimeIssue': '自動託管遇到執行期問題。',
  'hudChrome.hostedPlay.details.show': '查看詳細',
  'hudChrome.hostedPlay.details.hide': '收起詳細',
  'hudChrome.hostedPlay.details.title': '託管遊玩詳細資訊',
  'hudChrome.hostedPlay.details.empty': '暫時沒有託管診斷資訊。',
  'hudChrome.hostedPlay.details.none': '無',
  'hudChrome.hostedPlay.details.unavailable': '不可用',
  'hudChrome.hostedPlay.details.sectionBrain': '腦狀態',
  'hudChrome.hostedPlay.details.sectionMovement': '移動',
  'hudChrome.hostedPlay.details.sectionParty': '隊伍',
  'hudChrome.hostedPlay.details.sectionSocial': '社交',
  'hudChrome.hostedPlay.details.sectionLlmPlan': 'LLM 計畫',
  'hudChrome.hostedPlay.details.sectionLlmSocial': 'LLM 社交',
  'hudChrome.hostedPlay.details.lastBrain': '最近腦 tick',
  'hudChrome.hostedPlay.details.lastAutomation': '最近自動化 tick',
  'hudChrome.hostedPlay.details.objectiveId': '目標 ID',
  'hudChrome.hostedPlay.details.objectiveLabel': '目標說明',
  'hudChrome.hostedPlay.details.objectiveQuest': '任務 ID',
  'hudChrome.hostedPlay.details.objectiveDungeon': '地城 ID',
  'hudChrome.hostedPlay.details.partySize': '建議隊伍人數',
  'hudChrome.hostedPlay.details.objectiveSince': '目標開始於',
  'hudChrome.hostedPlay.details.lastProgress': '最近進展',
  'hudChrome.hostedPlay.details.lastError': '最近錯誤',
  'hudChrome.hostedPlay.details.brainDrivePaused': '腦驅動暫停',
  'hudChrome.hostedPlay.details.facing': '朝向',
  'hudChrome.hostedPlay.details.pathGoal': '路徑目標',
  'hudChrome.hostedPlay.details.pathLength': '路徑點數',
  'hudChrome.hostedPlay.details.nextPathPoint': '下一個路徑點',
  'hudChrome.hostedPlay.details.campIndex': '營地點序號',
  'hudChrome.hostedPlay.details.noTargetSince': '無目標開始於',
  'hudChrome.hostedPlay.details.stuckResets': '卡住重置次數',
  'hudChrome.hostedPlay.details.travelGoal': '行進目標',
  'hudChrome.hostedPlay.details.moveInput': '移動輸入',
  'hudChrome.hostedPlay.details.commands': '命令',
  'hudChrome.hostedPlay.details.lastCommandAges': '最近命令間隔',
  'hudChrome.hostedPlay.details.groupMode': '組隊模式',
  'hudChrome.hostedPlay.details.groupLeader': '隊長',
  'hudChrome.hostedPlay.details.groupDistance': '隊伍距離',
  'hudChrome.hostedPlay.details.partyPaused': '隊伍暫停腦驅動',
  'hudChrome.hostedPlay.details.llmEnabled': 'LLM 已啟用',
  'hudChrome.hostedPlay.details.llmPending': '等待中',
  'hudChrome.hostedPlay.details.llmStatus': '狀態',
  'hudChrome.hostedPlay.details.llmProvider': '提供方',
  'hudChrome.hostedPlay.details.llmLatency': '耗時',
  'hudChrome.hostedPlay.details.llmCacheHit': '快取命中',
  'hudChrome.hostedPlay.details.llmReason': '原因',
  'hudChrome.hostedPlay.details.llmMode': '模式',
  'hudChrome.hostedPlay.details.llmFocus': '關注點',
  'hudChrome.hostedPlay.details.llmTarget': '目標',
  'hudChrome.hostedPlay.details.promptChars': 'Prompt 字元數',
  'hudChrome.hostedPlay.details.rawOutputChars': '原始輸出字元數',
  'hudChrome.hostedPlay.details.planPrompt': '計畫 Prompt',
  'hudChrome.hostedPlay.details.planRawOutput': '計畫原始輸出',
  'hudChrome.hostedPlay.details.socialPrompt': '社交 Prompt',
  'hudChrome.hostedPlay.details.socialRawOutput': '社交原始輸出',
  ...
  'hudChrome.hostedPlay.details.travelGoalValue': '{target}，範圍 {range}，鍵 {key}',
  'hudChrome.hostedPlay.details.commandHeader': '{index}. {summary}',
  'hudChrome.hostedPlay.details.commandAgeValue': '{key}：{age}前',
  'hudChrome.hostedPlay.details.pendingReplyHeader': '回覆 {name}，版本 {revision}',
  'hudChrome.hostedPlay.details.pendingReplyIncoming': '收到內容',
  'hudChrome.hostedPlay.details.pendingReplyFallback': '備用回覆',
  'hudChrome.hostedPlay.details.pendingReplyDue': '到期時間',
  'hudChrome.hostedPlay.details.pendingReplyAskedFriend': '是否要求好友',
  'hudChrome.hostedPlay.details.pendingReplyLlmStatus': 'LLM 狀態',
  'hudChrome.hostedPlay.details.pendingReplyLlmReply': 'LLM 回覆',
  'hudChrome.hostedPlay.details.pendingReplyLlmFriend': 'LLM 好友動作',
  'hudChrome.hostedPlay.details.pendingReplyPresence': '存在感表情',
  'hudChrome.hostedPlay.details.pendingReplyRequested': 'LLM 請求於',
  'hudChrome.hostedPlay.partyMode.solo': '單人推進',
  'hudChrome.hostedPlay.partyMode.followLeader': '跟隨隊長',
  'hudChrome.hostedPlay.groupMode.none': '目前沒有隊伍協同行為',
  'hudChrome.hostedPlay.groupMode.brain': '正在執行常規推進邏輯',
  'hudChrome.hostedPlay.groupMode.followLeader': '正在跟隨隊長',
  'hudChrome.hostedPlay.groupMode.holdRegroup': '正在等待隊伍重新集合',
  'hudChrome.hostedPlay.llmStatus.pending': '等待中',
  'hudChrome.hostedPlay.llmStatus.accepted': '已採納',
  'hudChrome.hostedPlay.llmStatus.cacheHit': '快取命中',
  'hudChrome.hostedPlay.llmStatus.rejected': '已拒絕',
  'hudChrome.hostedPlay.llmStatus.error': '錯誤',
  'hudChrome.hostedPlay.llmStatus.budgetDenied': '預算受限',
  'hudChrome.hostedPlay.llmStatus.disabled': '已停用',
  'hudChrome.hostedPlay.llmMode.quiet': '安靜',
  'hudChrome.hostedPlay.llmMode.brief': '簡潔',
  'hudChrome.hostedPlay.llmMode.friendly': '友善',
  'hudChrome.hostedPlay.llmMode.helpful': '樂於助人',
  'hudChrome.hostedPlay.socialAction.friendAdd': '已向 {name} 傳送好友請求',
  'hudChrome.hostedPlay.socialAction.reply': '已回覆 {name}',
  'hudChrome.hostedPlay.socialAction.wave': '向 {name} 揮手',
  'hudChrome.hostedPlay.socialAction.cheer': '為 {name} 歡呼',
  'hudChrome.hostedPlay.socialAction.sentChat': '已傳送社交聊天指令',
  'hudChrome.hostedPlay.state.offline': '離線',
  'hudChrome.hostedPlay.state.disabled': '關閉',
  'hudChrome.hostedPlay.state.active': '執行中',
  'hudChrome.hostedPlay.state.paused': '已暫停',
  'hudChrome.hostedPlay.pause.runtimeError': '自動託管出錯後已暫停。',
  ...
  'auth.rememberOptions': '記住登入選項',
  'auth.rememberAccount': '記住帳號',
  ...
  'guide.worldPage.gladeBody': '谷地裡的故事並不全都關於亡者。北方有一片陽光灑落的林地，名為碧木林地，保有自己較溫和的節奏：安靜小徑、啃草的鹿，以及枝葉下警覺的野獸。它是你所追循之路旁的一段柔和對照，當道路給你餘裕漫遊時，很值得前去一看。',
  ...
  'seo.officialBody': 'worldofclaudecraft.com 是 Claudemoon 伺服器的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
