// Fork AI speech pack, registered under hudChrome.aiSpeech from hud_chrome.ts.
// Keeping the authored lines here limits merge pressure on the broader HUD chrome
// catalog and makes fork-only AI copy easier to track as one surface.

export const forkAiSpeechStrings = {
