...
export const DATABASE_URL =
  ...
  (() => {
    throw new Error(
      'DATABASE_URL is required. For local dev, copy .env.example to .env and run npm run db:up for the native PostgreSQL helper.',
    );
  })();
...
function hostedPlayPreferencesFromRow(
  ...
  return {
    ...
    autoInviteNearbyPlayers: row?.hosted_play_auto_invite_nearby === true,
