...
export function buildAmbientBotPartyChatPrompt(context: AmbientBotPartyChatContextV1): string {
  const lines = [
    ...
    '- Use intent.kind as the main behavior cue: route_plan plans movement, buffs waits for preparation, focus calls assist, praise reinforces clean play, correction calmly fixes spacing, recovery pauses to stabilize.',
    ...
    '- Correction may be direct but not insulting. Praise should be brief and tied to visible progress.',
