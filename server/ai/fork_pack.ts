...
export function buildForkAiProfilePack(
  basicNpcIntents: readonly AiIntentType[],
): readonly AiAgentProfile[] {
  const withBasicNpcIntents = (
    profile: Omit<AiAgentProfile, 'allowedIntentTypes'>,
  ): AiAgentProfile => ({
    ...profile,
    allowedIntentTypes: [...basicNpcIntents],
  });
