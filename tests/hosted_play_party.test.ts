...
describe('hosted-play party coordinator', () => {
  ...
  it('brings a combat-split hosted follower back to the leader before local fighting continues', () => {
    const state = createHostedPlayPartyState();
    ...
    const result = tickHostedPlayPartyCoordinator(
      {
        liveSelf: liveSelf({
          ...
          party: {
            ...
            members: [
              { pid: 101, name: 'Branoraaa', cls: 'warrior', level: 12, hp: 120, mhp: 120, res: 0, mres: 0, rtype: 'rage', x: 0, z: 0, dead: 0, inCombat: 1, group: 1 },
              { pid: 102, name: 'Hero', cls: 'mage', level: 12, hp: 100, mhp: 100, res: 120, mres: 120, rtype: 'mana', x: 22, z: 0, dead: 0, inCombat: 1, group: 1 },
            ],
          },
        }),
        entities: [
          { id: 501, k: 'mob', h: 80, x: 24, z: 0, aggro: 102, auras: [] },
        ],
        recentEvents: [],
        playerClass: 'mage',
        partyMode: 'follow_leader',
